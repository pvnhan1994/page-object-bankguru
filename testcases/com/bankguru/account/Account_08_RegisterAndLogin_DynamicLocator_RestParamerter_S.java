...
public class Account_08_RegisterAndLogin_DynamicLocator_RestParamerter_S extends AbstractTest {
	...
	public void TC_03_WebDriverCycle() throws Exception {
		...
		Thread.sleep(1000);
		// newaccount >> editccount
		newAccountPage.openMultiPages(driver, "Edit Account");
		Thread.sleep(1000);
		// editaccount >>homepage
		editAccountPage.openMultiPages(driver, "Manager");
		Thread.sleep(1000);
		// homepage >> deposit
		homePage.openMultiPages(driver, "Deposit");
		Thread.sleep(1000);
	}
